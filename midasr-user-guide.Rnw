...
lines(ny,col=2)
@ 
\caption{Quaterly GDP and Monthly Non-Farm Payroll Employment Growth Rate}
\end{figure}
...
indices provided by the Oxford-Man Institute of Quantitative Finance.
...
This process was repeated 1000 times. The points in the figure are the averages of the replications. The full code can be found on the website of package \pkg{midasr}.
